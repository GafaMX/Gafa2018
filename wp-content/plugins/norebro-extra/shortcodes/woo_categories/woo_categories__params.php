...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_subtitle_position_top.png',
					'key' => 'top',
					'title' => __( 'Top', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_subtitle_position_bottom.png',
					'key' => 'bottom',
