...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'heading' => __( 'Heading align', 'norebro-extra' ),
			'param_name' => 'module_type_layout',
			'value' => array(
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_align_middle.png',
					'key' => 'on_middle',
					'title' => __( 'Centred', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_align_left.png',
					'key' => 'on_left',
					'title' => __( 'Left Alignment', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_align_right.png',
					'key' => 'on_right',
					'title' => __( 'Right Alignment', 'norebro-extra' ),
				)
			)
		),
		array(
			...
			'value' => array(
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_bottom.png',
					'key' => 'bottom_subtitle',
					'title' => __( 'Bottom Subtitle', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_top.png',
					'key' => 'top_subtitle',
					'title' => __( 'Top Subtitle', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_without.png',
		...
		array(
			...
			'description' => __( 'If you want to add styles to a specific unit then use this field to add CSS class.', 'norebro-extra' ),
		),
	),
));