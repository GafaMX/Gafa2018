...
vc_map( array(
		...
		'custom_markup' => '{{title}}<div class="vc_norebro_team_member-container">
				<div class="_contain">
					<div class="photo" style="background-image: url(\'' . plugin_dir_url( __FILE__ ) . 'images/sc_gap_user.png\');"></div>
		...
		'params' => array(
			...
			array(
				...
				'value' => array(
					array(
						'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_full.png',
						'key' => 'full',
						'title' => __( 'Full Content', 'norebro-extra' ),
					),
					array(
						'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_inner.png',
						'key' => 'inner',
