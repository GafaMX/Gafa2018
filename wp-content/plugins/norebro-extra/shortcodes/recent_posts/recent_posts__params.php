...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'heading' => __( 'Posts category', 'norebro-extra' ),
		...
		array(
			'type' => 'dropdown',
			'group' => __( 'General', 'norebro-extra' ),
			'heading' => __( 'Post card layout type', 'norebro-extra' ),
		...
		array(
			'type' => 'norebro_check',
			'group' => __( 'General', 'norebro-extra' ),
			'heading' => __( 'Items boxed style', 'norebro-extra' ),
		...
		array(
			'type' => 'textfield',
			'group' => __( 'General', 'norebro-extra' ),
			'heading' => __( 'Posts in the block', 'norebro-extra' ),
