...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_type_default.png', //vs_settings_icon75.png',
					'key' => 'default',
					'title' => __( 'Outlined', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_type_filled.png', //vs_settings_icon73.png',
					'key' => 'filled',
		...
		array(
			...
			'value' => array(
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_ontop.png', //vs_settings_icon73.png',
					'key' => 'ontop',
					'title' => __( 'Horizontal', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_onleft.png', //vs_settings_icon74.png',
					'key' => 'onleft',
		...
		array(
			...
			'value' => array(
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_second_layout_ontop.png', //vs_settings_icon75.png',
					'key' => 'ontop',
					'title' => __( 'Horizontal', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_second_layout_onleft.png', //vs_settings_icon76.png',
					'key' => 'onleft',
					'title' => __( 'Vertical', 'norebro-extra' ),
				)
			),
