	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				...
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_border.png',
					'key' => 'border_items',
					'title' => __( 'Border Items', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_offset.png',
		...
		array(
			...
			'value' => array(
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_style_default.png',
					'key' => 'default',
					'title' => __( 'Default', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_style_line.png',
					'key' => 'line',
					'title' => __( 'Line', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_style_icon.png',
					'key' => 'icon',
					'title' => __( 'Icon', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_style_shape.png',
					'key' => 'shape_icon',
