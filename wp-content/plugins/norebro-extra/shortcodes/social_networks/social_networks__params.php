	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				...
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_fill.png',
					'key' => 'fill',
					'title' => __( 'Fill', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_flat.png',
					'key' => 'flat',
					'title' => __( 'Flat', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_inline.png',
					'key' => 'inline',
					'title' => __( 'Inline', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_text.png',
					'key' => 'text',
