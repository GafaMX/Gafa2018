...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'heading' => __( 'Accordion tabs style', 'norebro-extra' ),
			'param_name' => 'accordion_tabs_type',
			'value' => array(
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_tabs_style_default.png',
					'key' => 'default',
					'title' => __( 'Filled header', 'norebro-extra' )
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_tabs_style_outline.png',
					'key' => 'outline',
					'title' => __( 'Outline header', 'norebro-extra' )
				)
			)
		),
		array(
