...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_number.png',
					'key' => 'number',
					'title' => __( 'Number', 'norebro-extra' ),
				),
				array(
					'icon' => plugin_dir_url( __FILE__ ) . 'images/param_layout_icon.png',
					'key' => 'number_with_icon',
					'title' => __( 'Number with icon', 'norebro-extra' ),
				)
			)
		),
		array(
